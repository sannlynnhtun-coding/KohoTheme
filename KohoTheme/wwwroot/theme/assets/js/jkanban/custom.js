var kanban1 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="javascript:void(0)"><span class="date">23/7/20</span><span class="badge badge-primary f-right">Medium</span>
        ...
        {
          'title': `
                               <a class="kanban-box" href="javascript:void(0)"><span class="date">24/7/20</span><span class="badge badge-danger f-right">Urgent</span>
                                <h6>Test Sidebar</h6>
    ...
    },
    {
      ...
      'item': [{
        ...
        {
          'title': `
                               <a class="kanban-box" href="javascript:void(0)"><span class="date">24/7/20</span><span class="badge badge-success f-right">Low</span>
...
var kanban2 = new jKanban({
  ...
  boards: [{
      ...
      'item': [{
          'title': `
                               <a class="kanban-box" href="javascript:void(0)"><span class="date">24/7/20</span><span class="badge badge-info f-right">Medium</span>
                                <h6>Test Sidebar</h6>
                                <div class="d-flex"><img class="img-20 me-1 rounded-circle" src="../assets/images/user/1.jpg" alt="" data-original-title="" title="">
                                  <div class="flex-grow-1">
                                    <p>Themeforest, australia</p>
...
toDoButton.addEventListener.on('click', function() {
  kanban3.addElement(
    '_todo', {
      'title': `
                               <a class="kanban-box" href="javascript:void(0)"><span class="date">24/7/20</span><span class="badge badge-danger f-right">Urgent</span>
...
addBoardDefault.addEventListener.on('click', function() {
  kanban3.addBoards(
    [{
      'id': '_default',
...
removeBoard.addEventListener.on('click', function() {
